...
<head>
    ...
    <title>MinotaurCRM for Education Agents</title>
...
<div class="navbar navbar-inverse">
    <div class="navbar-header">
        <a class="navbar-brand" href="dashboard.html"><img src="assets/images/logo_light.png" alt=""></a>
                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li class="active"><a href="dashboard.html"><i class="icon-home4"></i> <span>Dashboard</span></a></li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="dashboard.html" id="layout2">Layout 2 <span class="label bg-warning-400">Current</span></a></li>
